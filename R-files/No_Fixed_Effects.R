...
# ---------------------------------------------------------------------------
#Balanced
didreg1 <- lm(WEF_defacto_score ~ treatment_TRIPS, data = data.no.nas)
#Unbalanced
didreg3 <- lm(WEF_defacto_score  ~ treatment_TRIPS, data = data.nas)  
...
# ---------------------------------------------------------------------------
didreg4 <- lm(EF_PR_dejure_score ~ treatment_TRIPS, data = data.no.nas) 
didreg6 <- lm(EF_PR_dejure_score ~ treatment_TRIPS, data = data.nas)  
